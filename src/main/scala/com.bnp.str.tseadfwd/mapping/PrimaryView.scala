...
object PrimaryView {
   ...
   * `emitNegative` — is what lets a NEGATIVE `EAD_RA_RATE` reach the output for the consistency-check
   ...
   *    and the consistency-check rule `CR02` can report it. Only meaningful together with
